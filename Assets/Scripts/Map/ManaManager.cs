...
public class ManaManager : MonoBehaviour
{
    ...
    private GameObject spawnedObjectsGroup; // GameObject để nhóm các mục sinh ra

    private void Start()
    {
        obstacles = new List<GameObject>();
        spawnedObjectsGroup = new GameObject("SpawnedObjectsGroup"); // Tạo một GameObject mới để nhóm các mục sinh ra
    }
    ...
    private void SpawnObstacle()
    {
        ...
        newObstacle.transform.parent = spawnedObjectsGroup.transform; // Đặt mục cha cho mục con
